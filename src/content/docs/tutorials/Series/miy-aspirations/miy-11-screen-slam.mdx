...
<LinkButton href="../miy-aspirations/miy-10-aspiration-tuning" icon="left-caret" iconPlacement="start">Back to Part 10</LinkButton>

<LinkButton href="../miy-aspirations-index" icon="up-caret" iconPlacement="start" variant="secondary">Back to the index</LinkButton>

<LinkButton href="../miy-aspirations/miy-12-objective-tuning" icon="right-caret" iconPlacement="start">On to Part 12</LinkButton>

---

Originally posted on [ilkavelle's Patreon](https://www.patreon.com/posts/144979182) as part of her Simsmas Modvent Calendar, and collected in the [Mod It Yourself series](https://www.patreon.com/collection/1867986?view=expanded), where you can ask questions in the comments.