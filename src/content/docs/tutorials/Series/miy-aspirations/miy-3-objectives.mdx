...
Open Sims4Studio and find Objectives tuning. For this tutorial I'll first show example on my [Simternet Conqueror Aspiration](https://www.patreon.com/posts/simternet-139697585).
...
Let's go now to String Table of the language you want to change (the language of your game). I was presenting this in details in this tutorial [Text (Strings)](../miy-2-text-strings), so here it will be a quick catch-up.

In the Data tab click "Edit Items" and the list with all strings will open.

I found in the list the text that we want to change. And you can see the reference visible in the Objective tuning: "D7AC93E8". This is how you can recognize which text was used in the specific tuning, if you have doubts.
...
<LinkButton href="../miy-2-text-strings" icon="left-caret" iconPlacement="start">Back to Part 2</LinkButton>
...
<LinkButton href="../miy-4-tokens" icon="right-caret" iconPlacement="start">On to Part 4</LinkButton>
